...
namespace Labixa.Areas.Admin.Controllers
{
    ...
    public partial class BlogController : BaseController
    {
        ...
        public ActionResult Create(BlogFormModel newBlog, bool continueEditing)
        {
            ...
            {
                newBlog.ListCategory = _blogCategoryService.GetBlogCategories().Where(p=>p.Id==3).ToSelectListItems(-1);
        ...
        public ActionResult Edit(BlogFormModel blogToEdit, bool continueEditing)
        {
            ...
            {
                blogToEdit.ListCategory = _blogCategoryService.GetBlogCategories().Where(p=>p.Id==3).ToSelectListItems(-1);
