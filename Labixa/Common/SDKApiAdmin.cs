...
//                HttpResponseMessage response = await client.GetAsync("api/dashboard/get?type=1&userName=" + userName);
...
//        }
//        #endregion
//        #region Call api Create Account
...
//                HttpResponseMessage response = await client.PostAsync("api/create-account/add", byteContent);
//                if (response.IsSuccessStatusCode)
//                {
//                    return response.Content.ReadAsStringAsync().Result;
//                }
...
//                client.DefaultRequestHeaders.Accept.Clear();
//                client.DefaultRequestHeaders.TryAddWithoutValidation("Content-Type", "application/json");
//                HttpResponseMessage response = await client.GetAsync("api/affiliate-account/get?username=" + userName + "&type=" + 1);
//                if (response.IsSuccessStatusCode)
//                {
//                    return response.Content.ReadAsStringAsync().Result;
//                }
...
//                var byteContent = new ByteArrayContent(buffer);
//                byteContent.Headers.ContentType = new MediaTypeHeaderValue("application/json");
//                HttpResponseMessage response = await client.PostAsync("api/trans-wallet/add", byteContent);
//                //if (response.IsSuccessStatusCode)
//                //{
//                //    return response.Content.ReadAsStringAsync().Result;
//                //}
...
//                client.DefaultRequestHeaders.Accept.Clear();
//                client.DefaultRequestHeaders.TryAddWithoutValidation("Content-Type", "application/json");
//                HttpResponseMessage response = await client.GetAsync("WebCallMail/MailTransactionETH" + "?id=" + id + "&email=" + email + "&timestamp=" + timestamp + "&Amount=" + amount + "&AddressTo=" + addressTo + "&FeeTransaction=" + fee + "&username=" + username + "&idTransaction=" + idTransaction + "&type=" + type);
//                if (response.IsSuccessStatusCode)
//                {
//                    return response.Content.ReadAsStringAsync().Result;
//                }
...
//                client.DefaultRequestHeaders.Accept.Clear();
//                client.DefaultRequestHeaders.TryAddWithoutValidation("Content-Type", "application/json");
//                HttpResponseMessage response = await client.GetAsync("WebCallMail/MailTransactionVIP" + "?id=" + id + "&email=" + email + "&timestamp=" + timestamp + "&Amount=" + amount + "&AddressTo=" + userTo + "&FeeTransaction=" + fee + "&username=" + username + "&idTransaction=" + idTransaction + "&type=" + type);
//                if (response.IsSuccessStatusCode)
//                {
//                    return response.Content.ReadAsStringAsync().Result;
//                }
...
//                client.DefaultRequestHeaders.Accept.Clear();
//                client.DefaultRequestHeaders.TryAddWithoutValidation("Content-Type", "application/json");
//                HttpResponseMessage response = await client.GetAsync("api/trans-wallet/get-max?username=" + username + "&currency=eth");
//                if (response.IsSuccessStatusCode)
//                {
...
//                client.DefaultRequestHeaders.Accept.Clear();
//                client.DefaultRequestHeaders.TryAddWithoutValidation("Content-Type", "application/json");
//                HttpResponseMessage response = await client.GetAsync("api/trans-wallet/get-max?username=" + username + "&currency=usd");
//                if (response.IsSuccessStatusCode)
//                {
//                    return double.Parse(response.Content.ReadAsStringAsync().Result);
//                }
...
//                client.DefaultRequestHeaders.Accept.Clear();
//                client.DefaultRequestHeaders.TryAddWithoutValidation("Content-Type", "application/json");
//                HttpResponseMessage response = await client.GetAsync("api/trans-wallet/get-limit?username=" + username);
//                if (response.IsSuccessStatusCode)
//                {
//                    return response.Content.ReadAsStringAsync().Result;
//                }
